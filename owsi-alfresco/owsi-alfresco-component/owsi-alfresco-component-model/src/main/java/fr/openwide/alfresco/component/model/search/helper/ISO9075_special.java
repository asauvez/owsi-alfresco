package fr.openwide.alfresco.component.model.search.helper;
 ...
 * 
 * Patch OPEN WIDE : 
 * Pris de @see org.alfresco.util.ISO9075 
 * et de @see com.sun.xml.fastinfoset.org.apache.xerces.util.XMLChar
 * 
 * Permet d'encoder les éléments de Path en ISO9075.
 * Par rapport à l'original, permet d'encoder également les accents.
 * 
 * @author asauvez
 * 
 */
        ...
        else
        {
            ...
            for (int i = 0; i < toEncode.length(); i++)
            {
                ...
                if (i == 0)
                {
                	...
                	if (c < 127 && (CHARS[c] & MASK_NCNAME_START) != 0)
                    {
                ...
                else if (! (c < 127 && (CHARS[c] & MASK_NCNAME) != 0))
                {
                    encode(c, builder);
                }
                else
