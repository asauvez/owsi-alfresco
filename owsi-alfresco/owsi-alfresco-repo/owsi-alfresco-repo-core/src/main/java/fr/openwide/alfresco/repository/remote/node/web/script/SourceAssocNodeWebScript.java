...
public class SourceAssocNodeWebScript extends AbstractNodeWebScript<List<RepositoryNode>, SOURCE_ASSOC_NODE_SERVICE> {
	...
	@Override
	protected List<RepositoryNode> executeImpl(Resource content, SOURCE_ASSOC_NODE_SERVICE parameter, Status status, Cache cache) throws RepositoryRemoteException {
