	...
	public void testGenerateFTS() throws Exception {
		assertEquals(
			...
			new RestrictionBuilder()
				...
				.eq(CmModel.cmobject.name, "toto").of()
				.eq(SysModel.referenceable.node_dbid, 123L).of()
				.startsWith(CmModel.cmobject.name, "titi").of()
				.match(CmModel.cmobject.name, "titi").fuzzy(0.9).of()
				.hasAspect(CmModel.workingcopy).not().of()
				.id(new NodeRef("workspace://SpacesStore/aeb883c2-ad52-43f1-ab9f-1bf16137e79c")).of()
				.eq(CmModel.thumbnail.contentPropertyName, CmModel.content.content.getQName()).of()
				...
				.gt(CmModel.cmobject.name, "abc").of()
				.le(CmModel.cmobject.name, "def").of()
				.site("swsdp").of()
				...
				.fingerPrint(new NodeRef("workspace://SpacesStore/aeb883c2-ad52-43f1-ab9f-1bf16137e79c"))
					...
					.confident(80).of()
				.or()
					.eq(CmModel.cmobject.name, "titi").of()
					.eq(CmModel.cmobject.name, "tata").of()
					.of()
				.or()
					.eq(CmModel.cmobject.name, "titi").of()
					.eq(CmModel.cmobject.name, "tata").of()
	...
	public void testGenerateCMIS() throws Exception {
		assertEquals(
			...
			new RestrictionBuilder()
				...
				.eq(CmModel.cmobject.name, "toto").of()
				.eq(CmModel.cmobject.name, "tata").not().of()
