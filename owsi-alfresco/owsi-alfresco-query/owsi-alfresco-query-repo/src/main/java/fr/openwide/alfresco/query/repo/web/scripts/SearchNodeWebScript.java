...
public class SearchNodeWebScript extends AbstractNodeSearchWebScript<List<NodeResult>, SEARCH_NODE_SERVICE> {

	@Override
	protected List<NodeResult> executeImpl(SEARCH_NODE_SERVICE parameter, Status status, Cache cache) throws RepositoryRemoteException {
